...
<html>
    ...
    <body>
        ...
        <div id="show-matricula" class="content scaffold-show" role="main">
            ...
            <f:display bean="matricula" />
            <g:form resource="${this.matricula}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.matricula}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
