...
<html>
    ...
    <body>
        ...
        <div id="show-telefone" class="content scaffold-show" role="main">
            ...
            <f:display bean="telefone" />
            <g:form resource="${this.telefone}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.telefone}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
