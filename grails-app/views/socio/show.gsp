...
<html>
    ...
    <body>
        ...
        <div id="show-socio" class="content scaffold-show" role="main">
            ...
            <f:display bean="socio" />
            <g:form resource="${this.socio}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.socio}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
