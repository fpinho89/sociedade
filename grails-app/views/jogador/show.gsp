...
<html>
    ...
    <body>
        ...
        <div id="show-jogador" class="content scaffold-show" role="main">
            ...
            <f:display bean="jogador" />
            <g:form resource="${this.jogador}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.jogador}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
